...
/**
 * Use this class to behave like a sensor in order to send events to centralized queue.
 */
@RestController
...
public class MockSensorController {
    ...
    public MockSensorController(SensorMessageProducer sensorMessageProducer) {
